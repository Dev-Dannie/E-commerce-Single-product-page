...
//             let cartCount = document.getElementById('shop-count')
...
//     const increaseCount = document.getElementById('shop-count')
//     console.log(increaseCount.innerText)
// let count = 0
// increaseCount.innerText = count++
// }

// function displayInputs(){
//     const details = document.querySelectorAll('.pdetails-content')
//     const qtyElement = document.querySelectorAll('.qty')
//     details.forEach(detail => {
//        let qtyInput =  detail.querySelector('.quantity-input')
//        console.log(qtyInput.value)
//        qtyElement.forEach(qty => {
//         qty.innerHTML = qtyInput.value
//        })
//     })
// }
...
sr.reveal(`.pdetails, .pdetails-img`, {origin: 'right'})
sr.reveal(`.pdetails, .pdetails-content`, {origin: 'left'})